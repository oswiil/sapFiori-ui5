		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "aplication",
									"targetURL": "#msupplyproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"msupplyproject1-display": {
								"semanticObject": "msupplyproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=msupply.project1",
									"url": sap.ui.require.toUrl("msupply/project1")
								}
							}
						}
					}
